...
async function seed() {
  ...
  await Promise.all([User.deleteMany({}), Indicator.deleteMany({}), Project.deleteMany({})]);
  ...
  await Indicator.create([
    {
      ...
      category: "Trend",
      shortDescription: "EMA-based trend filter with adaptive smoothing.",
      description:
      ...
      features: ["Adaptive EMA smoothing", "Built-in alert conditions", "Multi-timeframe confirmation"],
    ...
    },
    {
      ...
      category: "Momentum",
      shortDescription: "Automatic bullish/bearish divergence detection.",
      description:
      ...
      features: ["Auto divergence detection", "RSI + MACD confluence", "Configurable sensitivity"],
    ...
    },
    {
      ...
      category: "Volume",
      shortDescription: "Session-based volume profile with high-volume zone shading.",
      description:
        "Builds a rolling volume profile per session and shades the high-volume nodes traders use as support/resistance zones.",
      features: ["Session-based profile", "High-volume node shading", "Point of control line"],
  ...
  await Project.create([
    ...
    },
    {
      ...
      description: "Looking for an indicator that automatically draws support/resistance zones based on pivot clustering.",
      budget: "$100-150",
      timeline: "flexible",
      client: client._id,
      status: "new",
  ...
  console.log("Admin login:     admin@northbeam.dev / password123");
  console.log("Developer login: dev@northbeam.dev / password123");
  console.log("Client login:    client@northbeam.dev / password123");
