...
export default function Hero() {
  return (
    <section
      id="top"
      className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden grid-fade h-screen"
    >
      <div
        ...
        aria-hidden="true"
      />
      <div className="max-w-6xl mx-auto px-5 sm:px-8 grid lg:grid-cols-[1.1fr_0.9fr] gap-14 lg:gap-10 items-center relative flex-">
        <div
          style={{
            animation:
        ...
        >
          ...
          <p className="mt-6 text-text-dim text-lg max-w-lg leading-relaxed">
            ...
            not a single freelancer juggling ten inboxes. Every project gets its
            own dashboard, its own developer, and a direct line to them.
          </p>
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            ...
            <Link
              href="/indicators"
              className="font-mono text-sm text-text-dim hover:text-text border-b border-transparent hover:border-text-dim transition-colors pb-0.5"
            >
              View our indicators
            </Link>
          </div>
          ...
          {/* <div className="mt-12 flex items-center gap-6 flex-wrap">
            <div className="flex items-center gap-1.5 text-amber">
              ...
              <span className="font-mono text-sm text-text ml-1">
