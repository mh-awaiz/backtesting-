...
export default async function DeveloperDashboard() {
  ...
  const [me, projects, dueSoonCount] = await Promise.all([
  ...
  return (
    <div className="pb-16">
      <Topbar
        ...
        right={<AvailabilityToggle initialAvailable={!!me?.available} />}
      />
      ...
      <div className="px-5 lg:px-8 mt-8">
        ...
        {projects.length === 0 ? (
          <EmptyState
            ...
            body="New inquiries are auto-assigned to available developers — toggle yourself available above to start receiving them."
          />
        ) : (
